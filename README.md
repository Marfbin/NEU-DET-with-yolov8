...
model = YOLO('/autodl-tmp/ultralytics-main/yolov8n.pt')  # load a pretrained model (recommended for training)
# model = YOLO('yolov8s.yaml').load('yolov8s.pt')  # build from YAML and transfer weights

# Train the model
if __name__ == '__main__':
    model.train(data='/autodl-tmp/ultralytics-main/data/data.yaml', epochs=200, imgsz=640, device='0')
```
